...
int main(int argc, char *argv[])
{
  ...
  for(Int_t run=firstRun; run<=lastRun; run++){
    ...
    // fileName = TString::Format("reconstructDecimatedPlots_%d_*.root", run);
    // fileName = TString::Format("filter260-370-400-762-speed/reconstructDecimatedPlots_%d_*.root", run);     
